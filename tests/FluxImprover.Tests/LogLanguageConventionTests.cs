...
public class LogLanguageConventionTests
{
    ...
    [Theory]
    [MemberData(nameof(FluxImproverAssemblyTypes))]
    public void FluxImprover_LoggerMessageAttributes_HaveAsciiOnlyMessages(Type type)
    {
        AssertNoHangul(type);
    }

    [Theory]
    [MemberData(nameof(FluxImproverLMSupplyAssemblyTypes))]
    public void FluxImproverLMSupply_LoggerMessageAttributes_HaveAsciiOnlyMessages(Type type)
    {
        AssertNoHangul(type);
    }
